...
void DES_Key(char Char_Key[8]);  //轮秘钥生成函数
void RotateL(bool *Input,int len);    //循环左移
void Transform(bool *Output, bool *Input, const int *Table, int Tablelen);    //转换
void Xor(bool *InputA, const bool *InputB, int len);   //异或                 
void Des_Run(char *Mingwen, char *DES_Key);   //核心加密算法
